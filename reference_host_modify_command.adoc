...
`-username _username_`
 a| 
Der Benutzername, der Zugriff auf diesen Host hat. Dies ist nur erforderlich, wenn der Host nicht von einem Management-Server verwaltet wird (d. h. ein ESXi-Host, der von einem vCenter verwaltet wird).
