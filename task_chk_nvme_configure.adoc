...
* Für einen ESXi-Host ist ONTAP Select 9.7 oder höher mit einem unterstützten Deploy-Verwaltungsprogramm erforderlich
...
Folgen Sie dem link:kvm-host-configuration-and-preparation-checklist.html["Checkliste zur Hostvorbereitung"] und überprüfen Sie die erforderlichen Informationen für das link:reference_chk_deploy_req_info.html["Installation des Bereitstellungsdienstprogramms"] und das link:reference_chk_select_req_info.html["ONTAP Select Installation"], um weitere Informationen zu erhalten.
