...
=== Verwalten der virtuellen Laufwerke
...
NOTE: ONTAP Select unterstützt alle im VMware Storage/SAN Compatibility Guide beschriebenen externen Storage Arrays, einschließlich iSCSI, Fibre Channel und Fibre Channel over Ethernet.
