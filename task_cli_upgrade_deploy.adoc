...
Sie können direkt auf ONTAP Select Deploy 9.18.1 von ONTAP Select Deploy 9.17.1 oder 9.16.1 aktualisieren. Um von einer früheren Version, zum Beispiel ONTAP Select Deploy 9.15.1, zu aktualisieren, müssen Sie zuerst auf ONTAP Select Deploy 9.16.1 oder 9.17.1 und dann auf ONTAP Select Deploy 9.18.1 aktualisieren.
