...
+
Weitere Informationen zu den benötigten Paketen und anderen Konfigurationsanforderungen finden Sie in der link:https://imt.netapp.com/matrix/#welcome["Interoperabilitäts-Matrix-Tool"^].
...
+
Weitere Informationen zur Konfiguration von PCI-Passthrough (DirectPath IO) für einen KVM-Hypervisor finden Sie in der link:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/5/html/virtualization/chap-virtualization-pci_passthrough#sect-Virtualization-PCI_passthrough-AI_device_to_a_host["Red Hat-Dokumentation"^].
