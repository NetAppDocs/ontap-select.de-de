...
. Wählen Sie oben auf der Seite die Registerkarte *Administration* und anschließend *Mediators*.
. Optional können Sie *Filter* auswählen, um Ihre Ansicht der von der Mediator-Service überwachten Zwei-Knoten-Cluster anzupassen.
