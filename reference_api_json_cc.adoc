...
NOTE: Ab ONTAP Select 9.10.1 wird der KVM-Hypervisor beim Erstellen neuer Cluster nicht mehr unterstützt. Das folgende Beispiel gilt für frühere Versionen, die KVM unterstützen.
