...
NetApp empfiehlt die Verwendung von ESX 8.0 oder höher und einer NVMe-Festplatte als Datenspeicher für die Systemfestplatten. Diese Konfiguration bietet die beste Leistung für die NVRAM Partition.


NOTE: Bei der Installation auf ESX 8.0 oder höher verwendet ONTAP Select den vNVMEe-Treiber, unabhängig davon, ob sich die Systemfestplatte auf einer SSD oder auf einer NVMe-Festplatte befindet. Dadurch wird die VM-Hardwareebene auf 13 gesetzt, was mit ESX 8.0 und höher kompatibel ist.
