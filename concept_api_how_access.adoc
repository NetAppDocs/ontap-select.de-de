...
NOTE: Die in ONTAP Select Deploy enthaltene REST-API besitzt eine Versionsnummer. Die API-Versionsnummer ist unabhängig von der Deploy-Versionsnummer. Das ONTAP Select 9.19.1 Deploy Verwaltungsprogramm beinhaltet Version 3 der REST-API.
