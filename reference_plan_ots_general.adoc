...
Weitere Informationen zur Vorbereitung Ihres Linux-Servers, einschließlich der erforderlichen Konfiguration und Softwarepakete, finden Sie in der link:kvm-host-configuration-and-preparation-checklist.html["Checkliste für die Hostkonfiguration"]. Beachten Sie die Hypervisor-Anforderungen für die aktuell unterstützten Linux-Distributionen.
...
Beziehen Sie sich auf die hypervisorspezifischen Planungshinweise und link:reference_release_notes.html["Versionshinweise"] für weitere Details zu den unterstützten Plattformen.
