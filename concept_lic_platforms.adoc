...
Die Standard-, Premium- und Premium-XL-Lizenzen unterstützen eine breite Palette an Hardware und Software. Aktuelle Informationen zu Hardware- und Softwareversionen finden Sie unter link:https://mysupport.netapp.com/matrix/["Interoperabilitäts-Matrix-Tool"^].
...
Red Hat Enterprise Linux 64-bit (KVM) 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.8, 8.7 und 8.6

Rocky Linux (KVM) 10.0, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7 und 8.6

*Hinweis*: Für KVM-Hypervisoren auf RHEL 10.1 und 10.0 sowie Rocky Linux 10.0 Hosts gibt es Einschränkungen beim Software-RAID-Workflow. Weitere Informationen finden Sie in den folgenden Knowledge Base-Artikeln:
...
====
.Wie geht es weiter?
link:concept_lic_workflow.html["Erfahren Sie mehr über den Kauf einer ONTAP Select Lizenz"]
