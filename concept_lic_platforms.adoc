...
.3+| Solid-State-Drives (SSDs) in einem ... | Hardware-RAID-Konfiguration | Nein | Ja. | Ja. 
...
Die Standard-, Premium- und Premium-XL-Lizenzen unterstützen eine breite Palette an Hardware und Software. Aktuelle Informationen zu Hardware- und Softwareversionen finden Sie in der link:https://mysupport.netapp.com/matrix/["Interoperabilitäts-Matrix-Tool"^].
...
2+| CPU Familie  a| 
Intel Xeon E5-26xx v3 (Haswell) oder höher

AMD EPYC Embedded 9004 oder höher und 8004
 a| 
Intel Xeon E5-26xx v3 (Haswell) oder höher
...
Rocky Linux (KVM) 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7 und 8.6
...
====
.Wie geht es weiter?
Erfahren Sie mehr überlink:concept_lic_workflow.html["Kauf einer ONTAP Select-Lizenz"]
