...
. Optional können Sie *Filter* auswählen, um die angezeigten Lizenzen einzuschränken.
...
Weitere Informationen zu ONTAP Select und zur Lizenzverlängerung finden Sie im Abschnitt Lizenzen, Installation, Upgrades und Deaktivierungen in der link:reference_faq.html#licenses-installation-upgrades-and-reverts["Häufig gestellte Fragen"].
