...
+
ONTAP Select unterstützt SVM DR als Quelle und Ziel mit maximal 16 Beziehungen. Die DR-Unterstützung der SVM ist auf die Verwendung der Quell-ONTAP-Version auf Version +2 beschränkt. Beispielsweise kann die ONTAP Select 9.12.1 Quelle eine Verbindung mit den Ziel-ONTAP-Versionen 9.12.1, 9.13.1 oder 9.14.1 herstellen.
...
* link:https://mysupport.netapp.com/site/systems/master-license-keys["Erfahren Sie mehr über NetApp ONTAP Master License Keys"^]
