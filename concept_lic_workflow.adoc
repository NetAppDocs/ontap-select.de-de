...
Lizenzieren der Website:: Sie erwerben eine Capacity Tier- und eine Capacity Pool-Lizenz auf verschiedenen Websites.
...
.Wie geht es weiter?
Erfahren Sie mehr über die Überlegungen zur Dimensionierung einer ONTAP Select Lizenz:

* link:sizing-capacity-tier-license.html["Kapazitäts-Tiers-Lizenz"]
* link:sizing-capacity-pool-license.html["Capacity Pools Lizenz"]


.Verwandte Informationen
link:task_adm_licenses.html["Erfahren Sie mehr über die Verwaltung von ONTAP Select Lizenzen"]
