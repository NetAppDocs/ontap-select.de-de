...
Im folgenden Beispiel wird gezeigt, wie eine Anti-Affinitätsregel für die ONTAP Select VMs erstellt wird. Wenn der ONTAP Select Cluster mehr als ein HA-Paar enthält, müssen alle Knoten im Cluster in diese Regel einbezogen werden.
