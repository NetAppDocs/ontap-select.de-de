...
* KVM auf Red Hat Enterprise Linux (RHEL) 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.2, 9.1, 9.0, 8.8, 8.7, and 8.6
* KVM auf Rocky Linux 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7, und 8.6
...
ONTAP Select unterstützt CPU-Modelle, die auf Intel Xeon Sandy Bridge und Advanced Micro Devices (AMD) Prozessoren basieren.

Weitere Informationen finden Sie in der  https://mysupport.netapp.com/matrix["Interoperabilitäts-Matrix-Tool"^].
...
.Prozessor
Zu den unterstützten Mikroprozessoren gehören Intel Xeon Serverprozessoren und AMD Prozessoren.

Weitere Informationen finden Sie unter link:https://www.intel.com/content/www/us/en/products/processors/xeon/view-all.html?Processor+Type=1003["Intel Xeon Prozessoren"^] und link:https://www.amd.com/en/products/processors/server/epyc.html["AMD EPYC Server-CPUs"^].
...
Erfahren Sie mehr überlink:concept_lic_platforms.html["die Plattformlizenzangebote für ONTAP Select"]
