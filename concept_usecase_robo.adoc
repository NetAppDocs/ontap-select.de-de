...
[NOTE]
====
Da alle VMware vSphere-Lizenzen unterstützt werden, können Sie die vSphere Remote Office Branch Office Standard- oder Advanced-Lizenz anstelle der Enterprise- oder Enterprise Plus-Lizenz wählen.

Alle vSphere und VSAN-Lizenzen werden unterstützt.
