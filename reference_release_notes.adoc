...
Sie können auf die link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3378465["ONTAP Select 9.19.1 Versionshinweise"^] zugreifen, um die Details zur aktuellen Version anzuzeigen.
