...
Sie können auf das zugreifen https://library.netapp.com/ecm/ecm_download_file/ECMLP2882082["Versionshinweise zu ONTAP Select 9.11.1"^] So zeigen Sie die Details zur aktuellen Version an.
