...
Sie können auf das zugreifen https://library.netapp.com/ecm/ecm_download_file/ECMLP3318065["Versionshinweise zu ONTAP Select 9.15.1"^] So zeigen Sie die Details zur aktuellen Version an.
