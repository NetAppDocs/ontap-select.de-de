...
Weitere Informationen zu den Host-Konfigurationsoptionen finden Sie in der link:esxi-host-configuration-and-preparation-checklist.html["Dokumentation zur ONTAP Select Installation"].
...
** Wählen Sie *Rechenzentrum* aus. Klicken Sie dann mit der rechten Maustaste und wählen Sie *OVF-Vorlage bereitstellen* aus.
