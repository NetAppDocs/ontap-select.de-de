...
Wenn Sie diese älteren Versionen verwenden und ein Upgrade versuchen, kann die ONTAP Select virtuelle Maschine in einen Zustand geraten, in dem sie nicht mehr gestartet werden kann. In diesem Fall müssen Sie ein Upgrade-Verfahren wählen, das Deploy nicht verwendet.
