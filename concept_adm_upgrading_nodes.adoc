...
. Aktualisieren Sie den ONTAP Select-Knoten mithilfe der Standard-ONTAP-Aktualisierungsverfahren mit der ONTAP Select Upgrade-Datei. Informationen zu unterstützten Upgrade-Pfaden finden Sie in der link:https://docs.netapp.com/us-en/ontap/upgrade/concept_upgrade_paths.html["Unterstützte ONTAP Upgrade-Pfade"^].
