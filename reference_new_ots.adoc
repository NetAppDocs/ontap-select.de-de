...
--
Aktualisierte KVM-Hypervisor-Unterstützung:: Ab ONTAP Select 9.17.1 wird der KVM-Hypervisor auf Red Hat Enterprise Linux (RHEL) 10.0 und 9.6 sowie auf Rocky Linux 10.0 und 9.6 unterstützt.
+
--
[NOTE]
====
