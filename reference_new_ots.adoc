...
Unterstützung für externes Schlüsselmanagement (KMIP):: Ab ONTAP Select 9.19.1 unterstützt ONTAP Select die externe Schlüsselverwaltung mithilfe des Key Management Interoperability Protocol (KMIP). Sie können die externe Schlüsselverwaltung nach der Bereitstellung eines ONTAP Select 9.19.1-Clusters oder nach dem Upgrade eines bestehenden Clusters auf ONTAP Select 9.19.1 aktivieren. Die externe Schlüsselverwaltung ist die einzige von ONTAP Select 9.19.1 unterstützte Schlüsselverwaltung. Weitere Informationen finden Sie unter link:reference_lic_ontap_features.html#licensed-ontap-features["ONTAP Funktionen sind standardmäßig lizenziert"].
+
--
ONTAP Select unterstützt weder Cloud Key Manager noch den ONTAP Onboard Key Manager.

--
Unterstützung für Advanced Micro Devices (AMD) Prozessoren:: Ab ONTAP Select 9.19.1 unterstützt ONTAP Select AMD-Prozessoren auf Kernel-basierten virtuellen Maschinen (KVM) und ESXi-Hypervisor-Hosts. Weitere Informationen finden Sie unter link:reference_plan_ots_hardware.html["VMware-Hypervisor und Hardwareüberlegungen"].
...
Aktualisierungen der Downloadoptionen für das ONTAP Select-Produkt:: Die Downloadoptionen für das Produkt ONTAP Select auf der NetApp Support Site ändern sich mit der Veröffentlichung von ONTAP Select 9.18.1 zu *ONTAP Select Deploy* und *ONTAP Select Image*. Diese beiden neuen Produkt-Downloadoptionen ersetzen die bisherigen vier Optionen, wie in der folgenden Tabelle dargestellt:
+
--
[cols="30,30,40"]
|===
| Frühere Produkt-Download-Option | Neue Produkt-Download-Option | Weitere Informationen finden Sie unter.... 


| ONTAP Select | ONTAP Select Deploy | link:task_install_deploy.html["Installieren Sie ONTAP Select Deploy"] 


| ONTAP Select Image-Installation | ONTAP Select Image | link:task_cli_deploy_image_add.html["Fügen Sie ein ONTAP Select-Image zur Bereitstellung hinzu"] 


| ONTAP Select Deploy Upgrade | ONTAP Select Deploy | link:task_cli_upgrade_deploy.html["Upgrade einer ONTAP Select Deploy Instanz"] 


| ONTAP Select Node-Upgrade | ONTAP Select Image | link:concept_adm_upgrading_nodes.html["ONTAP Select Knoten aktualisieren"] 
|===
--
...
--
Aktualisierte KVM-Hypervisor-Unterstützung:: Ab ONTAP Select 9.18.1 wird der KVM-Hypervisor auf Rocky Linux 10.1 unterstützt.
...
Software-RAID-Unterstützung für lokal angeschlossene NVMe-Festplatten auf KVM-Hosts:: ONTAP Select 9.17.1 führt die Software-RAID-Unterstützung für ONTAP Select lokal angeschlossene NVMe-Festplatten auf einem KVM-Hypervisor-Host ein.
+
--
...
--
Unterstützung für SnapMirror cloud:: Ab ONTAP Select 9.17.1 wird SnapMirror Cloud mit ONTAP Select unterstützt. SnapMirror Cloud ist eine lizenzierte ONTAP Funktion, die standardmäßig aktiviert ist, wenn Sie einen ONTAP Select 9.17.1 Cluster bereitstellen oder einen bestehenden ONTAP Select Cluster auf Version 9.17.1 aktualisieren.
+
--
https://docs.netapp.com/us-en/ontap/concepts/snapmirror-cloud-backups-object-store-concept.html["Erfahren Sie mehr über SnapMirror Cloud-Backups in Objektspeicher"^].

--
Unterstützung für SnapLock Select:: Ab ONTAP Select 9.17.1 wird SnapLock Select (einschließlich manipulationssicherer Snapshot-Sperrung) bei neuen Bereitstellungen automatisch lizenziert. Für Upgrades von ONTAP Select 9.16.1 und früher können Sie die SnapLock Select-Lizenz kostenlos von der link:https://mysupport.netapp.com/site/["NetApp Support Website"^] herunterladen und manuell anwenden. Weitere Informationen finden Sie unter link:reference_lic_ontap_features.html#licensed-ontap-features["ONTAP Funktionen sind standardmäßig lizenziert"].
...
+
--
vSAN ESA ist eine ESXi-spezifische Konfiguration und eine neue Architektur für VMware vSAN, die in vSphere 8 eingeführt wurde. vSAN ESA wurde entwickelt, um eine höhere Effizienz, Skalierbarkeit und Leistung zu bieten, insbesondere bei Verwendung von NVMe-basierten TLC-Flash-Geräten.

ONTAP Select Deploy und ONTAP Select for ESXi unterstützen die Konfiguration eines ONTAP Select Single-Node- und Multi-Node-Clusters, wobei entweder ein vSAN oder ein externes Array-Typ von Datastore für seinen Speicherpool verwendet wird.
...
--
Aktualisierte KVM-Hypervisor-Unterstützung:: Ab ONTAP Select 9.17.1 wird der KVM-Hypervisor auf Red Hat Enterprise Linux (RHEL) 10.1, 10.0, 9.7 und 9.6 und Rocky Linux 10.0, 9.7 und 9.6 unterstützt.
+
--
[NOTE]
====
...
Unterstützung für NetApp-Lizenzdateien aktualisiert:: Ab ONTAP Select 9.16.1 ist die Unterstützung für die NetApp License File (NLF) aktualisiert. Das neue NLF-Format umfasst Lizenzen für die ARP-, ONTAP S3- und S3 SnapMirror-Funktionen. link:reference_lic_ontap_features.html#licensed-ontap-features["Weitere Informationen ."].
+
--
...
--
Unterstützung für den autonomen Ransomware-Schutz:: ONTAP Select 9.16.1 bietet Unterstützung für Autonomous Ransomware Protection (ARP). ONTAP Select 9.16.1 unterstützt nur manuelle Updates für ARP, automatische Updates werden nicht unterstützt. Die ARP-Funktionslizenz ist in der NLF für ONTAP Select 9.16.1 enthalten. link:reference_lic_ontap_features.html#licensed-ontap-features["Weitere Informationen ."].
...
NOTE: Die Unterstützung für die Erweiterung und Verkleinerung von Clustern ist auf ESXi-Cluster beschränkt.
...
Aktualisierte Unterstützung für ONTAP Select Deploy:: Wenn Sie eine Version von ONTAP Select Deploy 9.14.1 verwenden, die niedriger als 9.14.1P2 ist, sollten Sie so bald wie möglich auf ONTAP Select Deploy 9.14.1P2 aktualisieren. Weitere Informationen finden Sie unter link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2886733["Versionshinweise zu ONTAP Select 9.14.1"^].
...
Aktualisierte Unterstützung für ONTAP Select Deploy:: Ab April 2024 ist ONTAP Select Deploy 9.13.1 nicht mehr auf der NetApp Support Site verfügbar. Wenn Sie ONTAP Select Deploy 9.13.1 verwenden, sollten Sie so bald wie möglich auf ONTAP Select Deploy 9.14.1P2 aktualisieren. Weitere Informationen finden Sie unter link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2886733["Versionshinweise zu ONTAP Select 9.14.1"^].
...
Seit April 2024 ist ONTAP Select Deploy 9.12.1 nicht mehr auf der NetApp Support Site verfügbar. Wenn Sie ONTAP Select Deploy 9.12.1 verwenden, sollten Sie so bald wie möglich auf ONTAP Select Deploy 9.14.1P2 aktualisieren. Weitere Informationen finden Sie unter link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2886733["Versionshinweise zu ONTAP Select 9.14.1"^].
...
+
NetApp empfiehlt dringend, dass Kunden eine vollständige Datenmigration von ONTAP Select für KVM auf eine andere ONTAP Plattform, einschließlich ONTAP Select für ESXi, planen und durchführen. Weitere Informationen finden Sie unter https://mysupport.netapp.com/info/communications/ECMLP2877451.html["EOA-Mitteilung"^]
