...
--
Unterstützung für SnapMirror Cloud:: Ab ONTAP Select 9.17.1 wird SnapMirror Cloud von ONTAP Select unterstützt. SnapMirror Cloud ist eine lizenzpflichtige ONTAP-Funktion, die standardmäßig aktiviert ist, wenn Sie einen ONTAP Select 9.17.1-Cluster bereitstellen oder einen bestehenden ONTAP Select Cluster auf Version 9.17.1 aktualisieren.
+
--
...
--
Aktualisierte KVM-Hypervisor-Unterstützung:: Ab ONTAP Select 9.17.1 wird KVM-Hypervisor auf Red Hat Enterprise Linux (RHEL) 10.1, 10.0, 9.7 und 9.6 und Rocky Linux 10.1, 10.0, 9.7 und 9.6 unterstützt.
+
--
[NOTE]
====
